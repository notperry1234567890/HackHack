...
public class RenderUtil {
  ...
  public static void drawText(String str, float x, float y, int color, boolean font) {
    if (font) {
      GameSenseMod.fontRenderer.drawStringWithShadow(str, x, y, color);
    } else {
  ...
  public static void drawRect(float x, float y, float w, float h, int color) {
    ...
    float lvt_5_3_ = (color >> 24 & 0xFF) / 255.0F;
    float lvt_6_1_ = (color >> 16 & 0xFF) / 255.0F;
    float lvt_7_1_ = (color >> 8 & 0xFF) / 255.0F;
    float lvt_8_1_ = (color & 0xFF) / 255.0F;
