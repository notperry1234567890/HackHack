...
public class Trajectories2 extends Module {
  Setting.Integer redt;
  
  Setting.Integer greent;
  
  Setting.Integer bluet;
  
  public Trajectories2() {
    super("Trajectories2", Module.Category.Render);
  }
  
  public void setup() {
    this.redt = registerInteger("Red", "RedT", 255, 0, 255);
    this.greent = registerInteger("Green", "GreenT", 255, 0, 255);
    this.bluet = registerInteger("Blue", "BlueT", 255, 0, 255);
  }
